...
class LarvalLocalities extends StatefulWidget {
  final int survey;
  final String surveyName;
  const LarvalLocalities(
      {Key? key, required this.survey, required this.surveyName})
      : super(key: key);

  @override
  State<LarvalLocalities> createState() => _LarvalLocalitiesState();
}

class _LarvalLocalitiesState extends State<LarvalLocalities> {

...
import 'package:dengue/forms/ovitrapPremises.dart';
...
class OvitrapLocalities extends StatefulWidget {
  final int survey;
  final String surveyName;
  const OvitrapLocalities(
      {Key? key, required this.survey, required this.surveyName})
      : super(key: key);

  @override
  State<OvitrapLocalities> createState() => _OvitrapLocalitiesState();
}

class _OvitrapLocalitiesState extends State<OvitrapLocalities> {

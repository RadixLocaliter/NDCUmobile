...
import 'package:dengue/forms/adultPlaces.dart';
import 'package:dengue/forms/larvalPlaces.dart';
...
class AdultPremises extends StatefulWidget {
  final int survey_id;
  final dynamic gn;
  ...
  @override
  State<AdultPremises> createState() => _AdultPremisesState();
}

class _AdultPremisesState extends State<AdultPremises> {

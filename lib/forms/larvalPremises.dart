...
class LarvalPremises extends StatefulWidget {
  final int survey_id;
  final dynamic gn;
  final String locality;
  const LarvalPremises({
    Key? key,
  ...
  @override
  State<LarvalPremises> createState() => _LarvalPremisesState();
}

class _LarvalPremisesState extends State<LarvalPremises> {

...
import 'package:dengue/forms/OvitrapPlaces.dart';
...
class OvitrapPremises extends StatefulWidget {
  final int survey_id;
  final dynamic gn;
  final String locality;
  const OvitrapPremises({
    Key? key,
  ...
  @override
  State<OvitrapPremises> createState() => _OvitrapPremisesState();
}

class _OvitrapPremisesState extends State<OvitrapPremises> {
                                  ...
                                  onPressed: () {
                                    showCupertinoDialog<void>(
                                      ...
                                      builder: (BuildContext context) =>
                                        ...
                                        title: const Text('Add new Premise'),
                                        content: const Text(

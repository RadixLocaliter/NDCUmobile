...
import 'package:dengue/forms/pupalPremises.dart';
...
class PupalLocalities extends StatefulWidget {
  final int survey;
  final String surveyName;
  const PupalLocalities(
      {Key? key, required this.survey, required this.surveyName})
      : super(key: key);

  @override
  State<PupalLocalities> createState() => _PupalLocalitiesState();
}

class _PupalLocalitiesState extends State<PupalLocalities> {
